/*
 * DOTk_BoundLineSearchInexactNewtonGmresTest.cpp
 *
...
namespace DOTkBoundLineSearchInexactNewtonCgneTest
{

TEST(DOTk_BoundLineSearchInexactNewtonGMRES, getMin_UsrDefGrad_UsrDefHess_ArmijoLS_NoPrec_FeasDir)
{
    size_t ncontrols = 2;
...
TEST(DOTk_BoundLineSearchInexactNewtonGMRES, getMin_UsrDefGrad_UsrDefHess_ArmijoLS_NoPrec_ScaledProjectionAlongFeasDir)
{
    size_t ncontrols = 2;
    std::tr1::shared_ptr<dotk::DOTk_Primal> primal(new dotk::DOTk_Primal);
    primal->allocateSerialControlArray(ncontrols, 2);
...
TEST(DOTk_BoundLineSearchInexactNewtonGMRES, getMin_UsrDefGrad_LDFPHess_ArmijoLS_NoPrec_FeasDir)
{
    size_t ncontrols = 2;
    std::tr1::shared_ptr<dotk::DOTk_Primal> primal(new dotk::DOTk_Primal);
    primal->allocateSerialControlArray(ncontrols, 2);
...
TEST(DOTk_BoundLineSearchInexactNewtonGMRES, getMin_UsrDefGrad_LDFPHess_ArmijoLS_NoPrec_ScaledProjectionAlongFeasDir)
{
    size_t ncontrols = 2;
    std::tr1::shared_ptr<dotk::DOTk_Primal> primal(new dotk::DOTk_Primal);
    primal->allocateSerialControlArray(ncontrols, 2);
...
TEST(DOTk_BoundLineSearchInexactNewtonGMRES, getMin_UsrDefGrad_LSR1Hess_ArmijoLS_NoPrec_FeasDir)
{
    size_t ncontrols = 2;
    std::tr1::shared_ptr<dotk::DOTk_Primal> primal(new dotk::DOTk_Primal);
    primal->allocateSerialControlArray(ncontrols, 2);
...
TEST(DOTk_BoundLineSearchInexactNewtonGMRES, getMin_UsrDefGrad_LSR1Hess_ArmijoLS_NoPrec_ScaledProjectionAlongFeasDir)
{
    size_t ncontrols = 2;
    std::tr1::shared_ptr<dotk::DOTk_Primal> primal(new dotk::DOTk_Primal);
    primal->allocateSerialControlArray(ncontrols, 2);
...
TEST(DOTk_BoundLineSearchInexactNewtonGMRES, getMin_UsrDefGrad_DFPHess_ArmijoLS_NoPrec_FeasDir)
{
    size_t ncontrols = 2;
    std::tr1::shared_ptr<dotk::DOTk_Primal> primal(new dotk::DOTk_Primal);
    primal->allocateSerialControlArray(ncontrols, 2);
...
TEST(DOTk_BoundLineSearchInexactNewtonGMRES, getMin_UsrDefGrad_DFPHess_ArmijoLS_NoPrec_ScaledProjectionAlongFeasDir)
{
    size_t ncontrols = 2;
    std::tr1::shared_ptr<dotk::DOTk_Primal> primal(new dotk::DOTk_Primal);
    primal->allocateSerialControlArray(ncontrols, 2);
...
TEST(DOTk_BoundLineSearchInexactNewtonGMRES, getMin_UsrDefGrad_BBHess_ArmijoLS_NoPrec_FeasDir)
{
    size_t ncontrols = 2;
    std::tr1::shared_ptr<dotk::DOTk_Primal> primal(new dotk::DOTk_Primal);
    primal->allocateSerialControlArray(ncontrols, 2);
...
TEST(DOTk_BoundLineSearchInexactNewtonGMRES, getMin_UsrDefGrad_BBHess_ArmijoLS_NoPrec_ScaledProjectionAlongFeasDir)
{
    size_t ncontrols = 2;
    std::tr1::shared_ptr<dotk::DOTk_Primal> primal(new dotk::DOTk_Primal);
    primal->allocateSerialControlArray(ncontrols, 2);
...
TEST(DOTk_BoundLineSearchInexactNewtonGMRES, getMin_UsrDefGrad_SR1Hess_ArmijoLS_NoPrec_FeasDir)
{
    size_t ncontrols = 2;
    std::tr1::shared_ptr<dotk::DOTk_Primal> primal(new dotk::DOTk_Primal);
    primal->allocateSerialControlArray(ncontrols, 2);
...
TEST(DOTk_BoundLineSearchInexactNewtonGMRES, getMin_UsrDefGrad_SR1Hess_ArmijoLS_NoPrec_ScaledProjectionAlongFeasDir)
{
    size_t ncontrols = 2;
    std::tr1::shared_ptr<dotk::DOTk_Primal> primal(new dotk::DOTk_Primal);
    primal->allocateSerialControlArray(ncontrols, 2);
