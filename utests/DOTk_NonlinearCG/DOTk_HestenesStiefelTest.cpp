...
namespace DOTkHestenesStiefelTest
{

TEST(DOTk_HestenesStiefel, computeScaleFactor)
{
    size_t ncontrols = 2;
...
TEST(DOTk_HestenesStiefel, getDirection)
{
    ...
    EXPECT_NEAR(-20.428571428571427, dir.getScaleFactor(), tol);
}

TEST(DOTk_HestenesStiefel, direction)
{
    size_t ncontrols = 2;
    std::tr1::shared_ptr<dotk::DOTk_Primal> primal(new dotk::DOTk_Primal);
    primal->allocateSerialControlArray(ncontrols, 2);
