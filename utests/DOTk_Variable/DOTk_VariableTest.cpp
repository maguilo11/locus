...
{
    std::shared_ptr<dotk::Vector<Real> > data = dotk::gtest::allocateData(5, 1.);
    ...
    std::shared_ptr<dotk::Vector<Real> > lower = dotk::gtest::allocateData(5, -1.);
    std::shared_ptr<dotk::Vector<Real> > upper = dotk::gtest::allocateData(5, 5.);
...
{
    std::shared_ptr<dotk::Vector<Real> > data = dotk::gtest::allocateData(6, 1.);
    ...
    std::shared_ptr<dotk::Vector<Real> > lower = dotk::gtest::allocateData(6, -1.);
    std::shared_ptr<dotk::Vector<Real> > upper = dotk::gtest::allocateData(6, 5.);
...
{
    std::shared_ptr<dotk::Vector<Real> > data = dotk::gtest::allocateData(4, 1.);
    ...
    std::shared_ptr<dotk::Vector<Real> > lower = dotk::gtest::allocateData(4, -1.);
    std::shared_ptr<dotk::Vector<Real> > upper = dotk::gtest::allocateData(4, 5.);
