...
{
public:
    DOTk_ProjLeftPrecCgDataMng(const std::tr1::shared_ptr<dotk::DOTk_Primal> & primal_,
    ...
    void setGramSchmidtProjection(const std::tr1::shared_ptr<dotk::DOTk_Primal> & primal);

    const std::tr1::shared_ptr<dotk::DOTk_LeftPreconditioner> & getLeftPrec() const;
    void setLeftPrec(const std::tr1::shared_ptr<dotk::DOTk_LeftPreconditioner> & prec_);

    void setAugmentedSystemPrecWithPcgSolver(const std::tr1::shared_ptr<dotk::DOTk_Primal> & primal_);
    void setAugmentedSystemPrecWithGcrSolver(const std::tr1::shared_ptr<dotk::DOTk_Primal> & primal_);
    void setAugmentedSystemPrecWithCrSolver(const std::tr1::shared_ptr<dotk::DOTk_Primal> & primal_);
    void setAugmentedSystemPrecWithCgneSolver(const std::tr1::shared_ptr<dotk::DOTk_Primal> & primal_);
    void setAugmentedSystemPrecWithCgnrSolver(const std::tr1::shared_ptr<dotk::DOTk_Primal> & primal_);
