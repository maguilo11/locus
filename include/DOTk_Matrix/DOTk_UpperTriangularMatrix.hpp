...
template<typename ScalarType>
class DOTk_UpperTriangularMatrix : public dotk::matrix<ScalarType>
{
public:
    DOTk_UpperTriangularMatrix(size_t num_rows_, ScalarType value_ = 0.);
...
private:
    DOTk_UpperTriangularMatrix(const dotk::serial::DOTk_UpperTriangularMatrix<ScalarType> &);
    dotk::serial::DOTk_UpperTriangularMatrix<ScalarType> & operator=(const dotk::serial::DOTk_UpperTriangularMatrix<ScalarType> & rhs_);
};
