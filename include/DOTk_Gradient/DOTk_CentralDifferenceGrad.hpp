...
{
public:
    explicit DOTk_CentralDifferenceGrad(const std::shared_ptr<dotk::Vector<Real> > & vector_);
    ...
    void getGradient(const std::shared_ptr<dotk::DOTk_AssemblyManager> & interface_,
