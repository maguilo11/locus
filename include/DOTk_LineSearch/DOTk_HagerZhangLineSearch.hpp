...
{
public:
    explicit DOTk_HagerZhangLineSearch(const std::shared_ptr<dotk::Vector<Real> > & vector_);
    ...
    Real secantStep(const std::shared_ptr<dotk::Vector<Real> > & trial_step_,
    ...
    void doubleSecantStep(const std::shared_ptr<dotk::Vector<Real> > & trial_step_,
                          const std::shared_ptr<dotk::Vector<Real> > & primal_old_,
                          const std::shared_ptr<dotk::Vector<Real> > & primal_new_,
                          const std::shared_ptr<dotk::Vector<Real> > & gradient_new_,
                          const std::shared_ptr<dotk::DOTk_OptimizationDataMng> & mng_);
