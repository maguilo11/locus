...
DOTk_BFGSInvHessian::DOTk_BFGSInvHessian(const std::shared_ptr<dotk::Vector<Real> > & vector_) :
...
const std::shared_ptr<dotk::Vector<Real> > & DOTk_BFGSInvHessian::getDeltaGrad() const
{
    return (mDeltaGradient);
}

const std::shared_ptr<dotk::Vector<Real> > & DOTk_BFGSInvHessian::getDeltaPrimal() const
{
    return (mDeltaPrimal);
}

void DOTk_BFGSInvHessian::getInvHessian(const std::shared_ptr<dotk::Vector<Real> > & vector_,
...
void DOTk_BFGSInvHessian::apply(const std::shared_ptr<dotk::DOTk_OptimizationDataMng> & mng_,
