...
DOTk_ArnoldiProjection::DOTk_ArnoldiProjection(const std::tr1::shared_ptr<dotk::DOTk_Primal> & primal_,
...
void DOTk_ArnoldiProjection::initialize(const std::tr1::shared_ptr<dotk::DOTk_Primal> & primal_)
{
