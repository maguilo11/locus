...
DOTk_RoutinesTypeLP::DOTk_RoutinesTypeLP(const std::shared_ptr<dotk::DOTk_ObjectiveFunction<Real> > & objective_,
...
Real DOTk_RoutinesTypeLP::objective(const std::shared_ptr<dotk::Vector<Real> > & control_)
{
...
void DOTk_RoutinesTypeLP::gradient(const std::shared_ptr<dotk::Vector<Real> > & control_,
