...
DOTk_ProjLeftPrecCgDataMng::DOTk_ProjLeftPrecCgDataMng(const std::tr1::shared_ptr<dotk::DOTk_Primal> & primal_,
...
const std::tr1::shared_ptr<dotk::DOTk_OrthogonalProjection> & DOTk_ProjLeftPrecCgDataMng::getProjection() const
{
    return (m_ProjectionMethod);
}

void DOTk_ProjLeftPrecCgDataMng::setGramSchmidtProjection(const std::tr1::shared_ptr<dotk::DOTk_Primal> & primal_)
{
...
void DOTk_ProjLeftPrecCgDataMng::setArnoldiProjection(const std::tr1::shared_ptr<dotk::DOTk_Primal> & primal_)
{
...
const std::tr1::shared_ptr<dotk::DOTk_LeftPreconditioner> & DOTk_ProjLeftPrecCgDataMng::getLeftPrec() const
{
    return (m_LeftPreconditioner);
}

void DOTk_ProjLeftPrecCgDataMng::setLeftPrec(const std::tr1::shared_ptr<dotk::DOTk_LeftPreconditioner> & prec_)
{
