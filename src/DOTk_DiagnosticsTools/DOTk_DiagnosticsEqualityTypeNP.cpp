                                                                        ...
                                                                        std::ostringstream & msg_)
{
    ...
    std::shared_ptr<dotk::Vector<Real> > perturbation = vars.mState->clone();
                                                                          ...
                                                                          std::ostringstream & msg_)
{
    ...
    dotk::nlp::variables vars(*state_.data(), *control_.data(), *dual_.data());
    std::shared_ptr<dotk::Vector<Real> > perturbtation = vars.mControl->clone();
                                                                                 ...
                                                                                 std::ostringstream & msg_)
{
    ...
    std::shared_ptr<dotk::Vector<Real> > perturbation = vars.mControl->clone();
    dotk::gtools::generateRandomVector(perturbation);
...
(const std::shared_ptr< dotk::Vector<Real> > & perturbation_vec_,
 ...
 dotk::nlp::variables & variables_)
{
    ...
    std::shared_ptr<dotk::Vector<Real> > residual = dotk::nlp::clone(variables_, codomain);
    std::shared_ptr<dotk::Vector<Real> > finite_diff_first_derivative = dotk::nlp::clone(variables_, codomain);
    std::shared_ptr<dotk::Vector<Real> > true_first_derivative = dotk::nlp::clone(variables_, codomain);
...
(const std::shared_ptr< dotk::Vector<Real> > & perturbation_vec_,
 ...
 dotk::nlp::variables & variables_)
{
    std::shared_ptr<dotk::Vector<Real> > first_derivative_times_direction = variables_.mDual->clone();
    first_derivative_(m_ContinuousOperators,
                      variables_.mState,
                      variables_.mControl,
                      perturbation_vec_,
                      first_derivative_times_direction);
    std::shared_ptr<dotk::Vector<Real> > adjoint_first_derivative_times_dual = perturbation_vec_->clone();
...
(const std::shared_ptr< dotk::Vector<Real> > & perturbation_,
 const AdjointVectorValuedFunctionFirstDerivative& adjoint_first_derivative_,
 const AdjointVectorValuedFunctionSecondDerivative& adjoint_second_derivative_,
 dotk::nlp::variables & variables_)
{
    dotk::types::variable_t codomain = dotk::DOTk_DerivativeDiagnosticsTool::getCodomain();
    std::shared_ptr<dotk::Vector<Real> > true_adjoint_second_derivative_times_direction =
    ...
    std::shared_ptr<dotk::Vector<Real> > adjoint_first_derivative = dotk::nlp::clone(variables_, codomain);
    std::shared_ptr<dotk::Vector<Real> > finite_diff_adjoint_second_derivative_times_direction =
            dotk::nlp::clone(variables_, codomain);
