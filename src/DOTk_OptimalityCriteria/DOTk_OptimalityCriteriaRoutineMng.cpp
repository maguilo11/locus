...
void DOTk_OptimalityCriteriaRoutineMng::solveEqualityConstraint(std::shared_ptr<dotk::DOTk_OptimalityCriteriaDataMng> & mng_)
{
...
Real DOTk_OptimalityCriteriaRoutineMng::evaluateObjectiveFunction(std::shared_ptr<dotk::DOTk_OptimalityCriteriaDataMng> & mng_)
{
...
void DOTk_OptimalityCriteriaRoutineMng::computeObjectiveFunctionGradient(std::shared_ptr<dotk::DOTk_OptimalityCriteriaDataMng> & mng_)
{
...
void DOTk_OptimalityCriteriaRoutineMng::computeMaxControlRelativeDifference(std::shared_ptr<dotk::DOTk_OptimalityCriteriaDataMng> & mng_)
{
...
Real DOTk_OptimalityCriteriaRoutineMng::computeInequalityConstraintResidual(std::shared_ptr<dotk::DOTk_OptimalityCriteriaDataMng> & mng_)
{
...
void DOTk_OptimalityCriteriaRoutineMng::computeInequalityConstraintGradient(std::shared_ptr<dotk::DOTk_OptimalityCriteriaDataMng> & mng_)
{
