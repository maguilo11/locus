                           ...
                           const std::tr1::shared_ptr<dotk::DOTk_OptimizationDataMng> & opt_mng_)
{
    ...
    while (1)
    {
        ...
        m_ProjectionOperatorTimesVec->copy(*m_DataMng->getLeftPrecTimesVector());
        ...
        m_DataMng->getRightPrecTimesVector()->axpy(static_cast<Real>(1.), *m_DataMng->getSolution());
        ...
        m_DataMng->getResidual()->copy(*rhs_vec_);
        m_DataMng->getResidual()->axpy(static_cast<Real>(-1.), *m_DataMng->getMatrixTimesVector());
    ...
    m_DataMng->getSolution()->copy(*m_DataMng->getRightPrecTimesVector());
}
