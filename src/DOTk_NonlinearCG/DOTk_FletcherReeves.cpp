...
Real DOTk_FletcherReeves::computeScaleFactor(const std::shared_ptr<dotk::Vector<Real> > & old_grad_,
...
void DOTk_FletcherReeves::getDirection(const std::shared_ptr<dotk::Vector<Real> > & old_grad_,
                                       const std::shared_ptr<dotk::Vector<Real> > & new_grad_,
...
void DOTk_FletcherReeves::direction(const std::shared_ptr<dotk::DOTk_OptimizationDataMng> & mng_)
{
