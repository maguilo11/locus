...
Real DOTk_PerryShanno::computeAlphaScaleFactor(const std::shared_ptr<dotk::Vector<Real> > & old_grad_,
...
Real DOTk_PerryShanno::computeThetaScaleFactor(const std::shared_ptr<dotk::Vector<Real> > & old_grad_,
                                               const std::shared_ptr<dotk::Vector<Real> > & new_grad_,
...
Real DOTk_PerryShanno::computeScaleFactor(const std::shared_ptr<dotk::Vector<Real> > & old_grad_,
                                          const std::shared_ptr<dotk::Vector<Real> > & new_grad_,
                                          const std::shared_ptr<dotk::Vector<Real> > & dir_)
{
    Real dir_dot_new_grad = dir_->dot(*new_grad_);
...
void DOTk_PerryShanno::getDirection(const std::shared_ptr<dotk::Vector<Real> > & old_grad_,
                                    const std::shared_ptr<dotk::Vector<Real> > & new_grad_,
                                    const std::shared_ptr<dotk::Vector<Real> > & old_primal_,
                                    const std::shared_ptr<dotk::Vector<Real> > & new_primal_,
                                    const std::shared_ptr<dotk::Vector<Real> > & dir_)
...
void DOTk_PerryShanno::direction(const std::shared_ptr<dotk::DOTk_OptimizationDataMng> & mng_)
{
