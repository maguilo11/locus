...
DOTK_SecantLeftPreconditioner::DOTK_SecantLeftPreconditioner(const std::shared_ptr<dotk::Vector<Real> > & vector_,
...
void DOTK_SecantLeftPreconditioner::setLbfgsPreconditioner(const std::shared_ptr<dotk::Vector<Real> > & vector_,
                                                           size_t secant_storage_)
{
...
void DOTK_SecantLeftPreconditioner::setLdfpPreconditioner(const std::shared_ptr<dotk::Vector<Real> > & vector_,
                                                          size_t secant_storage_)
{
    dotk::DOTk_InverseHessianFactory factory;
...
void DOTK_SecantLeftPreconditioner::setLsr1Preconditioner(const std::shared_ptr<dotk::Vector<Real> > & vector_,
                                                          size_t secant_storage_)
{
    dotk::DOTk_InverseHessianFactory factory;
...
void DOTK_SecantLeftPreconditioner::setBfgsPreconditioner(const std::shared_ptr<dotk::Vector<Real> > & vector_)
{
    dotk::DOTk_InverseHessianFactory factory;
...
void DOTK_SecantLeftPreconditioner::setSr1Preconditioner(const std::shared_ptr<dotk::Vector<Real> > & vector_)
{
    dotk::DOTk_InverseHessianFactory factory;
...
void DOTK_SecantLeftPreconditioner::setBarzilaiBorweinPreconditioner(const std::shared_ptr<dotk::Vector<Real> > & vector_)
{
    dotk::DOTk_InverseHessianFactory factory;
...
void DOTK_SecantLeftPreconditioner::apply(const std::shared_ptr<dotk::DOTk_OptimizationDataMng> & opt_mng_,
