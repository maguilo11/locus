...
DOTk_CentralDifferenceGrad::DOTk_CentralDifferenceGrad(const std::shared_ptr<dotk::Vector<Real> > & vector_) :
...
const std::shared_ptr<dotk::Vector<Real> > & DOTk_CentralDifferenceGrad::getFiniteDiffPerturbationVec() const
{
...
void DOTk_CentralDifferenceGrad::getGradient(const std::shared_ptr<dotk::DOTk_AssemblyManager> & interface_,
