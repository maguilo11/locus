...
DOTk_ParallelForwardDiffGrad::DOTk_ParallelForwardDiffGrad(const std::shared_ptr<dotk::Vector<Real> > & vector_) :
...
const std::shared_ptr<dotk::Vector<Real> > & DOTk_ParallelForwardDiffGrad::getFiniteDiffPerturbationVec() const
{
...
void DOTk_ParallelForwardDiffGrad::initialize(const std::shared_ptr<dotk::Vector<Real> > & vector_)
{
