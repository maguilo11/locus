...
void DOTk_MexTrustRegionLinMore::solveTypeLinearProgramming(const mxArray* input_[], mxArray* output_[])
{
    ...
    std::shared_ptr<dotk::DOTk_MexObjectiveFunction> objective =
            std::make_shared<dotk::DOTk_MexObjectiveFunction>(m_ObjectiveFunction, m_ProblemType);
    std::shared_ptr<dotk::DOTk_SteihaugTointDataMng> data = std::make_shared<dotk::DOTk_SteihaugTointDataMng>(primal, objective);
    ...
    std::shared_ptr<dotk::DOTk_SteihaugTointStepMng> step = std::make_shared<dotk::DOTk_SteihaugTointStepMng>(primal,
                                                                                                              hessian);
...
void DOTk_MexTrustRegionLinMore::solveTypeNonlinearProgramming(const mxArray* input_[], mxArray* output_[])
{
    ...
    std::shared_ptr<dotk::DOTk_MexEqualityConstraint> equality =
            std::make_shared<dotk::DOTk_MexEqualityConstraint>(m_EqualityConstraint, m_ProblemType);
    std::shared_ptr<dotk::DOTk_SteihaugTointDataMng> data = std::make_shared<dotk::DOTk_SteihaugTointDataMng>(primal,
                                                                                                              objective,
                                                                                                              equality);
...
void DOTk_MexTrustRegionLinMore::solveTypeBoundLinearProgramming(const mxArray* input_[], mxArray* output_[])
{
    ...
    std::shared_ptr<dotk::DOTk_MexObjectiveFunction> objective =
            std::make_shared<dotk::DOTk_MexObjectiveFunction>(m_ObjectiveFunction, m_ProblemType);
    std::shared_ptr<dotk::DOTk_SteihaugTointDataMng> data =
            std::make_shared<dotk::DOTk_SteihaugTointDataMng>(primal, objective);
    ...
    // Set trust region step manager
    std::shared_ptr<dotk::DOTk_SteihaugTointProjGradStep> step =
            std::make_shared<dotk::DOTk_SteihaugTointProjGradStep>(primal, hessian);
    dotk::DOTk_MexSteihaugTointNewton::setTrustRegionStepParameters(step);
...
void DOTk_MexTrustRegionLinMore::solveTypeBoundNonlinearProgramming(const mxArray* input_[], mxArray* output_[])
{
    ...
    std::shared_ptr<dotk::DOTk_MexEqualityConstraint> equality =
            std::make_shared<dotk::DOTk_MexEqualityConstraint>(m_EqualityConstraint, m_ProblemType);
    std::shared_ptr<dotk::DOTk_SteihaugTointDataMng> data =
            std::make_shared<dotk::DOTk_SteihaugTointDataMng>(primal, objective, equality);
