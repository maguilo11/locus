function [Options, Operators] = setAlgorithmGCMMA(Inputs)
Options = [];
% Set Solution Type
Options.SolutionType = 'GCMMA';
% Set Container Type
...
Options = setOptionsGCMMA(Options);
...
function [Options] = setOptionsGCMMA(Options)
