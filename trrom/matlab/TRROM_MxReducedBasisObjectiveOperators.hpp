/*
 * TRROM_MxReducedBasisObjectiveOperators.hpp
 *
 *  Created on: Dec 23, 2016
 *      Author: Miguel A. Aguilo Valentin
 */

#ifndef TRROM_MXREDUCEDBASISOBJECTIVEOBJECTIVE_HPP_
#define TRROM_MXREDUCEDBASISOBJECTIVEOBJECTIVE_HPP_
...
class MxReducedBasisObjectiveOperators : public trrom::ReducedBasisObjectiveOperators
{
public:
    //! @name Constructors/destructors
    //@{
    /*!
     * Creates a MxReducedBasisObjectiveOperators object
     * Parameters:
     *    \param In
     *          input_: MEX array pointer
     *
     * \return Reference to MxReducedBasisObjectiveOperators.
     *
     **/
    explicit MxReducedBasisObjectiveOperators(const mxArray* input_);
    //! MxReducedBasisObjectiveOperators destructor.
    virtual ~MxReducedBasisObjectiveOperators();
    //@}
...
private:
    MxReducedBasisObjectiveOperators(const trrom::MxReducedBasisObjectiveOperators &);
    trrom::MxReducedBasisObjectiveOperators & operator=(const trrom::MxReducedBasisObjectiveOperators & rhs_);
};

}

#endif /* TRROM_MXREDUCEDBASISOBJECTIVEOBJECTIVE_HPP_ */
