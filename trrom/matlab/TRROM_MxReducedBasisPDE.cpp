...
MxReducedBasisPDE::MxReducedBasisPDE(const mxArray* input_) :
        ...
        m_ApplyAdjointInverseJacobianState(mxDuplicateArray(mxGetField(input_, 0, "applyInverseAdjointJacobianState"))),
...
void MxReducedBasisPDE::applyInverseAdjointJacobianState(const trrom::Vector<double> & state_,
                                                         const trrom::Vector<double> & control_,
                                                         const trrom::Vector<double> & rhs_,
                                                         trrom::Vector<double> & solution_)
{
    ...
    std::ostringstream msg;
    msg << "\nERROR IN: " << __FILE__ << ", LINE: " << __LINE__
            << ", -> Error while calling applyInverseAdjointJacobianState.\n";
    trrom::mx::handleException(error, msg.str());
