...
Operators.applyInverseAdjointJacobianState=@(state,control,rhs) applyInverseAdjointJacobianState(state,control,rhs);
...
function [output] = applyInverseAdjointJacobianState(state,control,rhs)
