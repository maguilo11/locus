...
AugmentedLagrangianTypeNP::AugmentedLagrangianTypeNP(const std::shared_ptr<trrom::Data> & input_,
...
double AugmentedLagrangianTypeNP::objective(const std::shared_ptr<trrom::Vector<double> > & control_,
...
void AugmentedLagrangianTypeNP::gradient(const std::shared_ptr<trrom::Vector<double> > & control_,
...
void AugmentedLagrangianTypeNP::hessian(const std::shared_ptr<trrom::Vector<double> > & control_,
...
void AugmentedLagrangianTypeNP::computeObjectiveGradient(const trrom::Vector<double> & control_)
{
    ...
    m_PDE->applyInverseAdjointJacobianState(*m_State, control_, *m_StateWorkVec, *m_ObjectiveDual);
                                                                    ...
                                                                    trrom::Vector<double> & gradient_)
{
    ...
    for(int index = 0; index < num_inequality_constraints; ++ index)
    {
        ...
        m_PDE->applyInverseAdjointJacobianState(*m_State, control_, *m_StateWorkVec, *(m_InequalityDual[index]));
        this->updateInverseAdjointJacobianStateCounter();
                                                            ...
                                                            const trrom::Vector<double> & vector_)
{
    ...
    m_PDE->applyInverseAdjointJacobianState(*m_State, control_, *m_StateWorkVec, *m_ObjectiveDeltaDual);
    this->updateInverseAdjointJacobianStateCounter();
}
                                                                       ...
                                                                       const trrom::Vector<double> & vector_)
{
    ...
    m_PDE->applyInverseAdjointJacobianState(*m_State, control_, *m_StateWorkVec, *m_InequalityDeltaDual[index_]);
    this->updateInverseAdjointJacobianStateCounter();
}
