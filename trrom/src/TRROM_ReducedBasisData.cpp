...
std::tr1::shared_ptr<trrom::Vector<double> > ReducedBasisData::createReducedDualSolutionCopy() const
{
    try
    {
    ...
    return (m_ReducedDualSolution->create());
}
...
std::tr1::shared_ptr<trrom::Matrix<double> > ReducedBasisData::createDualOrthonormalBasisCopy() const
{
    try
    {
    ...
    return (m_DualOrthonormalBasis->create());
}
...
std::tr1::shared_ptr<trrom::Matrix<double> > ReducedBasisData::createReducedDualLeftHandSideCopy() const
{
    try
    {
    ...
    return (m_ReducedDualLeftHandSide->create());
}
...
std::tr1::shared_ptr<trrom::Vector<double> > ReducedBasisData::createReducedDualRightHandSideCopy() const
{
    try
    {
    ...
    return (m_ReducedDualRightHandSide->create());
}
...
std::tr1::shared_ptr<trrom::Vector<double> > ReducedBasisData::createReducedStateSolutionCopy() const
{
    try
    {
    ...
    return (m_ReducedStateSolution->create());
}
...
std::tr1::shared_ptr<trrom::Matrix<double> > ReducedBasisData::createStateOrthonormalBasisCopy() const
{
    try
    {
    ...
    return (m_StateOrthonormalBasis->create());
}
...
std::tr1::shared_ptr<trrom::Matrix<double> > ReducedBasisData::createReducedStateLeftHandSideCopy() const
{
    try
    {
    ...
    return (m_ReducedStateLeftHandSide->create());
}
...
std::tr1::shared_ptr<trrom::Vector<double> > ReducedBasisData::createReducedStateRightHandSideCopy() const
{
    try
    {
    ...
    return (m_ReducedStateRightHandSide->create());
}
...
std::tr1::shared_ptr<trrom::Vector<double> > ReducedBasisData::createLeftHandSideSnapshotCopy() const
{
    try
    {
    ...
    return (m_LeftHandSideSnapshot->create());
}
...
std::tr1::shared_ptr<trrom::Vector<double> > ReducedBasisData::createRightHandSideSnapshotCopy() const
{
    try
    {
    ...
    return (m_RightHandSideSnapshot->create());
}

std::tr1::shared_ptr<trrom::Matrix<double> > ReducedBasisData::createLeftHandSideOrthonormalBasisCopy() const
{
    try
    {
    ...
    return (m_LeftHandSideOrthonormalBasis->create());
}
...
std::tr1::shared_ptr<trrom::Vector<double> > ReducedBasisData::createLeftHandSideDeimCoefficientsCopy() const
{
    try
    {
    ...
    return (m_LeftHandSideDeimCoefficients->create());
}
