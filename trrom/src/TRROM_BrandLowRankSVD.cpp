...
BrandLowRankSVD::BrandLowRankSVD(const std::shared_ptr<trrom::BrandMatrixFactory> & brand_factory_,
                                 const std::shared_ptr<trrom::LinearAlgebraFactory> & linear_algebra_factory_,
...
void BrandLowRankSVD::solve(const std::shared_ptr<trrom::Matrix<double> > & data_set_,
                            ...
                            std::shared_ptr<trrom::Matrix<double> > & right_singular_vectors_)
{
    ...
    std::shared_ptr<trrom::Matrix<double> > M;
    ...
    std::shared_ptr<trrom::Matrix<double> > P_bar = data_set_->create();
    ...
    std::shared_ptr<trrom::Matrix<double> > K;
    ...
    std::shared_ptr<trrom::Vector<double> > reduced_singular_values;
    std::shared_ptr<trrom::Matrix<double> > reduced_left_singular_vectors;
    std::shared_ptr<trrom::Matrix<double> > reduced_right_singular_vectors;
    ...
    std::shared_ptr<trrom::Matrix<double> > Ubar;
    ...
    std::shared_ptr<trrom::Matrix<double> > Vbar;
