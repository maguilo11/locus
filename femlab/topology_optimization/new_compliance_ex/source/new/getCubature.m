...
cellType = usr_par.mesh.cellType;
sideType = usr_par.mesh.sideType;
cubDegreeCell = usr_par.cubDegreeCell;
cubDegreeSide = usr_par.cubDegreeSide;

%%%%%%%%%%% evaluate cell cubature points and weights
numCubPoints = intrepid_getNumCubaturePoints(cellType, cubDegreeCell);
cubPoints    = zeros(spaceDim, numCubPoints);
cubWeights   = zeros(1, numCubPoints);
intrepid_getCubature(cubPoints, cubWeights, cellType, cubDegreeCell);
