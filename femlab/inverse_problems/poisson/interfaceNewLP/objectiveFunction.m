...
switch GLB_INVP.reg
    case{'Tikhonov'}
        reg = 0.5 * GLB_INVP.beta * (control'*(GLB_INVP.M*control));
    case{'TV'}
...
potential = -GLB_INVP.theta * ...
    (alpha*((state'*dK_state) + (GLB_INVP.exp_state'*dK_data)))';

%%%%%%%%%%% compute regularization term
switch GLB_INVP.reg
    case{'Tikhonov'}
        reg = GLB_INVP.beta * (GLB_INVP.M*control);
    case{'TV'}
...
switch GLB_INVP.reg
    case{'Tikhonov'}
        reg = GLB_INVP.beta .* (GLB_INVP.M*dcontrol);
    case{'TV'}
