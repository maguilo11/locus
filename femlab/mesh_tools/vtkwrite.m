function vtkwrite(filename, t, p, u, c)
% vtkwrite
...
%
%         inspired by Daniel Peterseim's writeVTK
%
	
% Extract array sizes.
[np, dim]  = size(p);  % number of mesh vertices, dimension
[nt, nvpc] = size(t);  % number of cells, number of vertices per cell
...
fprintf(FID, s, [nvpc*ones(nt,1) t-1]');

% Write cell types.
fprintf(FID, 'CELL_TYPES %d\n', nt);
s = '%d\n';
fprintf(FID, s, ctm(c)*ones(nt,1));
